 ...
 */
package com.pentasecurity.processors.download;
...
import com.pentasecurity.processors.download.callback.DownloadCallback;
...
public class AutoDownloadProcessor extends AbstractProcessor {
    /**
     *  - 마켓 서버 로그인 처리
